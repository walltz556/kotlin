...
import org.jetbrains.kotlin.noarg.ide.IdeNoArgDeclarationChecker
...
class TestNoArgForLightClass : KotlinLightCodeInsightFixtureTestCase() {
    ...
    override fun setUp() {
        ...
        configurationArguments.pluginOptions = arrayOf("${IdeNoArgDeclarationChecker.ANNOTATION_OPTION_PREFIX}$noArgAnnotationName")
    }
    ...
    fun testNoArgAnnotation() {
        val file = myFixture.configureByText(
            ...
            "annotation class $noArgAnnotationName\n"
                    + "@HelloNoArg class $targetClassName(val e: Int)"
        ) as KtFile

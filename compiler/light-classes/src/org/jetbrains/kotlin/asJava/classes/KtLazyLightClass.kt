...
abstract class KtLazyLightClass(manager: PsiManager) : KtLightClassBase(manager) {
    ...
    private val _getOwnFields: List<KtLightField> by lazyPub { lightClassData.getOwnFields(this) }
    override fun getOwnFields() = _getOwnFields

    private val _getOwnMethods: List<KtLightMethod> by lazyPub { lightClassData.getOwnMethods(this) }
